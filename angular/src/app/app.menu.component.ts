...
export class AppMenuComponent implements OnInit {
    ...
    constructor(public app: AppHome,private httpRestClient:HttpRestClient) {
    ...
    ngOnInit() {
        ...
        .subscribe(
                ...
                this.model = [
                        ...
                        var count:number;
                        for(count = 0;count<this.menuItems.length;count++) {
                            this.model.push(this.menuItems[count]);   
                        }
                }
        );
...
export class AppSubMenuComponent {
    ...
    constructor(public app: AppHome) { }
