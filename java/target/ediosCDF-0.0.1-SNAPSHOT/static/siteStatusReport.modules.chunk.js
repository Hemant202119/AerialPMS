webpackJsonp(["siteStatusReport.modules"],{

/***/ "./src/app/_screens/reports/site-status-report/site-status-report.component.css":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__guards_role_rights_guard__ = __webpack_require__("./src/app/_guards/role-rights.guard.ts");
...
var SiteStatusReportComponent = (function () {
    function SiteStatusReportComponent(httpRestClient, dateFormater, roleRightsGuard, breadcrumbService) {
        ...
        this.roleRightsGuard.hasAllRoles(__WEBPACK_IMPORTED_MODULE_6__app_config__["e" /* routeConfig */].siteStatusReport);
    ...
    SiteStatusReportComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    SiteStatusReportComponent.prototype.getReports = function () {
        var _this = this;
        this.msgs = [];
    ...
    SiteStatusReportComponent.prototype.resetAll = function () {
        // this.showPageSpinner=true;
    ...
    SiteStatusReportComponent.prototype.onCircleClick = function (event) {
        var _this = this;
        this.reportBean.userID = this.currentuser.userID;
    ...
    SiteStatusReportComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-site-status-report',
            template: __webpack_require__("./src/app/_screens/reports/site-status-report/site-status-report.component.html"),
            styles: [__webpack_require__("./src/app/_screens/reports/site-status-report/site-status-report.component.css")],
            providers: [__WEBPACK_IMPORTED_MODULE_3__angular_common__["DatePipe"], __WEBPACK_IMPORTED_MODULE_7__core_date_format__["a" /* DateFormatPipe */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_http_rest_client_service__["a" /* HttpRestClient */], __WEBPACK_IMPORTED_MODULE_3__angular_common__["DatePipe"], __WEBPACK_IMPORTED_MODULE_4__guards_role_rights_guard__["a" /* RoleRightsGuard */],
            __WEBPACK_IMPORTED_MODULE_5__breadcrumb_service__["a" /* BreadcrumbService */]])
    ], SiteStatusReportComponent);
    return SiteStatusReportComponent;
}());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SiteStatusReportModule", function() { return SiteStatusReportModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__screens_reports_site_status_report_site_status_report_component__ = __webpack_require__("./src/app/_screens/reports/site-status-report/site-status-report.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__routing_siteStatusReport_routing__ = __webpack_require__("./src/app/routing/siteStatusReport.routing.ts");
...
var SiteStatusReportModule = (function () {
    function SiteStatusReportModule() {
        // console.log('Role Module loaded.');
    }
    SiteStatusReportModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__routing_siteStatusReport_routing__["a" /* SiteStatusReportRoutingModule */],
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_10__screens_reports_site_status_report_site_status_report_component__["a" /* SiteStatusReportComponent */]
            ],
            providers: [],
            exports: []
        }),
        __metadata("design:paramtypes", [])
    ], SiteStatusReportModule);
    return SiteStatusReportModule;
}());
...
/***/ "./src/app/routing/siteStatusReport.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SiteStatusReportRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__screens_reports_site_status_report_site_status_report_component__ = __webpack_require__("./src/app/_screens/reports/site-status-report/site-status-report.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var sitesStatusRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_2__screens_reports_site_status_report_site_status_report_component__["a" /* SiteStatusReportComponent */] },
];
var SiteStatusReportRoutingModule = (function () {
    function SiteStatusReportRoutingModule() {
    }
    SiteStatusReportRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"].forChild(sitesStatusRoutes)],
            exports: [__WEBPACK_IMPORTED_MODULE_1__angular_router__["RouterModule"]]
        })
    ], SiteStatusReportRoutingModule);
    return SiteStatusReportRoutingModule;
}());
...
//# sourceMappingURL=siteStatusReport.modules.chunk.js.map